...
system = System(
    cpu=O3CPU(cpu_id=0),  # Initialize cpu type
    mem_mode="timing",
...
# width = 4
# system.cpu.fetchWidth = width
# system.cpu.decodeWidth = width
# system.cpu.renameWidth = width
# system.cpu.dispatchWidth = width
# system.cpu.issueWidth = width
# system.cpu.wbWidth = width
# system.cpu.commitWidth = width
...
# system.cpu.numPhysVecRegs   = 128
# system.cpu.numPhysCCRegs    = 128

system.cpu.numROBEntries = 384  # default ~192
system.cpu.numIQEntries = 128  # issue queue size
# system.cpu.numPhysIntRegs = 256
# system.cpu.numPhysFloatRegs = 256
# system.cpu.numPhysVecRegs = 256
# system.cpu.numPhysCCRegs = 256
# system.cpu.LQEntries = 64       # load queue
# system.cpu.SQEntries = 64       # store queue
